...
import TextField from '@mui/material/TextField';// import { response } from 'express';
...
export default function SignUp() {
    ...
    const [userPassword, setUserPassword] = useState('');  //비밀번호 값을 입력 받음
    const [userPasswordCheck, setUserPasswordCheck] = useState('');  //비밀번호 입력값을 받음
